...
class Migration(migrations.Migration):
    ...
    dependencies = [("accounts", "0003_verificationtoken")]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Title of the blog", max_length=64, verbose_name="Title"
                    ),
                ),
                (
                    "image",
                    models.ImageField(
                        upload_to=apps.accounts.models.blog.upload_to, verbose_name="Image"
                    ),
                ),
