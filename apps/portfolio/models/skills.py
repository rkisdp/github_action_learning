...
# project imports
from apps.portfolio import constants
from apps.portfolio.managers.skills import SkillManager, SkillQueryset
...
class Skill(TimeStampable):
    ...
    name = models.CharField(verbose_name=_("Skill Name"), max_length=64)
